...
const EditFooterSocialMediaModalContent = (props) => {
  ...
  const IS_EDITED =
    JSON.stringify(column) !==
      JSON.stringify(sellerConfigs.UIConfig.Footer.columns[1]) ||
    Boolean(newItem.label) ||
    Boolean(newItem.hyperlink);
  ...
  const handleSave = () => {
    ...
    const AT_LEAST_ONE_OF_THE_FIELDS_OF_NEW_ITEM_IS_FILLED = Boolean(
      newItem.label || newItem.hyperlink
    );
                ...
                <tr key={"row-" + i}>
                  ...
                  <td>
                    <input
                      ...
                      onChange={(e) =>
                        handlePropertyChange("hyperlink", e.target.value, i)
                      }
                      className="form-control m-0"
                      style={{
                        height: "100%",
              ...
              >
                ...
                >
                  <input
                    ...
                    placeholder={"e.g. /order-tracking"}
                    onChange={(e) =>
                      handleNewItemPropertyChange("hyperlink", e.target.value)
                    }
                    className="form-control m-0"
                    style={{
                      height: "100%",
